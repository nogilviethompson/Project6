...
namespace stemming
	...
	public:
		...
		void operator()(std::basic_string<Tchar_type, Tchar_traits>& text)
			...
			if (text.length() >= 5 &&
				...
				{
				this->find_r1(text, "aeiouyAEIOUY");
				}

			this->find_r2(text, "aeiouyAEIOUY");
	...
	int m_r1, m_r2, m_rv;
		...
		void step_1a(std::basic_string<Tchar_type, Tchar_traits>& text)
			{
			if (this->is_suffix(text,/*sses*/'s', 'S', 's', 'S', 'e', 'E', 's', 'S') )
				{
				text.erase(text.end()-2, text.end() );
				this->update_r_sections(text);
				}
			else if (this->is_suffix(text,/*ied*/'i', 'I', 'e', 'E', 'd', 'D') ||
					this->is_suffix(text,/*ies*/'i', 'I', 'e', 'E', 's', 'S') )
				{
				if (text.length() == 4)
					{
		...
		void step_1b(std::basic_string<Tchar_type, Tchar_traits>& text)
			...
			if (this->is_suffix(text,/*eed*/'e', 'E', 'e', 'E', 'd', 'D') )
				{
			...
			else if (this->is_suffix(text,/*eedly*/'e', 'E', 'e', 'E', 'd', 'D', 'l', 'L', 'y', 'Y') )
				{
			...
			else if (this->is_suffix(text,/*ed*/'e', 'E', 'd', 'D') &&
				m_first_vowel < text.length()-2)
				{
			...
			else if (this->is_suffix(text,/*edly*/'e', 'E', 'd', 'D', 'l', 'L', 'y', 'Y') &&
			...
			else if (this->is_suffix(text,/*ing*/'i', 'I', 'n', 'N', 'g', 'G') &&
			...
			else if (this->is_suffix(text,/*ingly*/'i', 'I', 'n', 'N', 'g', 'G', 'l', 'L', 'y', 'Y') &&
			...
			if (regress_trim)
				{
				if (this->is_suffix(text,/*at*/'a', 'A', 't', 'T') ||
					this->is_suffix(text,/*bl*/'b', 'B', 'l', 'L') ||
					this->is_suffix(text,/*iz*/'i', 'I', 'z', 'Z') )
					{
				...
				else if (this->is_suffix(text,/*bb*/'b', 'B', 'b', 'B') ||
						this->is_suffix(text,/*dd*/'d', 'D', 'd', 'D') ||
						this->is_suffix(text,/*ff*/'f', 'F', 'f', 'F') ||
						this->is_suffix(text,/*gg*/'g', 'G', 'g', 'G') ||
						this->is_suffix(text,/*mm*/'m', 'M', 'm', 'M') ||
						this->is_suffix(text,/*nn*/'n', 'N', 'n', 'N') ||
						this->is_suffix(text,/*pp*/'p', 'P', 'p', 'P') ||
						this->is_suffix(text,/*rr*/'r', 'R', 'r', 'R') ||
						this->is_suffix(text,/*tt*/'t', 'T', 't', 'T') )
					{
					text.erase(text.end()-1, text.end() );
					this->update_r_sections(text);
					}
...
#undef EITHER_LOOSE
		...
		void step_2(std::basic_string<Tchar_type, Tchar_traits>& text)
			{
			if (this->is_suffix(text,/*ization*/'i', 'I', 'z', 'Z', 'a', 'A', 't', 'T', 'i', 'I', 'o', 'O', 'n', 'N') )
				{
			...
			else if (this->is_suffix(text,/*ational*/'a', 'A', 't', 'T', 'i', 'I', 'o', 'O', 'n', 'N', 'a', 'A', 'l', 'L') )
				{
				if (m_r1 <= text.length()-7)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*fulness*/'f', 'F', 'u', 'U', 'l', 'L', 'n', 'N', 'e', 'E', 's', 'S', 's', 'S') )
				{
				if (m_r1 <= text.length()-7)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*ousness*/'o', 'O', 'u', 'U', 's', 'S', 'n', 'N', 'e', 'E', 's', 'S', 's', 'S') )
				{
				if (m_r1 <= text.length()-7)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*iveness*/'i', 'I', 'v', 'V', 'e', 'E', 'n', 'N', 'e', 'E', 's', 'S', 's', 'S') )
				{
				if (m_r1 <= text.length()-7)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*tional*/'t', 'T', 'i', 'I', 'o', 'O', 'n', 'N', 'a', 'A', 'l', 'L') )
				{
			...
			else if (this->is_suffix(text,/*lessli*/'l', 'L', 'e', 'E', 's', 'S', 's', 'S', 'l', 'L', 'i', 'I') )
				{
				if (m_r1 <= text.length()-6)
					{
					text.erase(text.end()-2, text.end() );
			...
			else if (this->is_suffix(text,/*biliti*/'b', 'B', 'i', 'I', 'l', 'L', 'i', 'I', 't', 'T', 'i', 'I') )
				{
				if (m_r1 <= text.length()-6)
					{
					text.erase(text.end()-3, text.end() );
			...
			else if (this->is_suffix(text,/*iviti*/'i', 'I', 'v', 'V', 'i', 'I', 't', 'T', 'i', 'I') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-2, text.end() );
			...
			else if (this->is_suffix(text,/*fulli*/'f', 'F', 'u', 'U', 'l', 'L', 'l', 'L', 'i', 'I') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-2, text.end() );
			...
			else if (this->is_suffix(text,/*ation*/'a', 'A', 't', 'T', 'i', 'I', 'o', 'O', 'n', 'N') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-2, text.end() );
			...
			else if (this->is_suffix(text,/*alism*/'a', 'A', 'l', 'L', 'i', 'I', 's', 'S', 'm', 'M') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-3, text.end() );
			...
			else if (this->is_suffix(text,/*aliti*/'a', 'A', 'l', 'L', 'i', 'I', 't', 'T', 'i', 'I') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-3, text.end() );
			...
			else if (this->is_suffix(text,/*ousli*/'o', 'O', 'u', 'U', 's', 'S', 'l', 'L', 'i', 'I') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-2, text.end() );
			...
			else if (this->is_suffix(text,/*entli*/'e', 'E', 'n', 'N', 't', 'T', 'l', 'L', 'i', 'I') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-2, text.end() );
			...
			else if (this->is_suffix(text,/*alli*/'a', 'A', 'l', 'L', 'l', 'L', 'i', 'I') )
				{
			...
			else if (this->is_suffix(text,/*enci*/'e', 'E', 'n', 'N', 'c', 'C', 'i', 'I') )
				{
				if (m_r1 <= text.length()-4)
					{
					text[text.length()-1] = 'e';
			...
			else if (this->is_suffix(text,/*anci*/'a', 'A', 'n', 'N', 'c', 'C', 'i', 'I') )
				{
				if (m_r1 <= text.length()-4)
					{
					text[text.length()-1] = 'e';
			...
			else if (this->is_suffix(text,/*abli*/'a', 'A', 'b', 'B', 'l', 'L', 'i', 'I') )
				{
				if (m_r1 <= text.length()-4)
					{
					text[text.length()-1] = 'e';
			...
			else if (this->is_suffix(text,/*izer*/'i', 'I', 'z', 'Z', 'e', 'E', 'r', 'R') )
				{
				if (m_r1 <= text.length()-4)
					{
					text.erase(text.end()-1, text.end() );
			...
			else if (this->is_suffix(text,/*ator*/'a', 'A', 't', 'T', 'o', 'O', 'r', 'R') )
				{
				if (m_r1 <= text.length()-4)
					{
					text.erase(text.end()-1, text.end() );
				...
				this->is_suffix(text,/*bli*/'b', 'B', 'l', 'L', 'i', 'I') )
				{
				text[text.length()-1] = 'e';
				}
			else if (m_r1 <= static_cast<int>(text.length()-3) &&
				this->is_suffix(text,/*ogi*/'o', 'O', 'g', 'G', 'i', 'I') )
				{
				if (is_either(text[text.length()-4], 'l', 'L') )
					...
					this->is_suffix(text,/*li*/'l', 'L', 'i', 'I') )
				{
		...
		void step_3(std::basic_string<Tchar_type, Tchar_traits>& text) 
			{
			if (this->is_suffix(text,/*ational*/'a', 'A', 't', 'T', 'i', 'I', 'o', 'O', 'n', 'N', 'a', 'A', 'l', 'L') )
				{
				if (m_r1 <= text.length()-7)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*alize*/'a', 'A', 'l', 'L', 'i', 'I', 'z', 'Z', 'e', 'E') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-3, text.end() );
			...
			else if (this->is_suffix(text,/*icate*/'i', 'I', 'c', 'C', 'a', 'A', 't', 'T', 'e', 'E') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-3, text.end() );
			...
			else if (this->is_suffix(text,/*iciti*/'i', 'I', 'c', 'C', 'i', 'I', 't', 'T', 'i', 'I') )
				{
				if (m_r1 <= text.length()-5)
					{
					text.erase(text.end()-3, text.end() );
			...
			else if (this->is_suffix(text,/*ative*/'a', 'A', 't', 'T', 'i', 'I', 'v', 'V', 'e', 'E') )
				{
			...
			else if (this->is_suffix(text,/*ical*/'i', 'I', 'c', 'C', 'a', 'A', 'l', 'L') )
				{
				if (m_r1 <= text.length()-4)
					{
					text.erase(text.end()-2, text.end() );
			...
			else if (this->is_suffix(text,/*ness*/'n', 'N', 'e', 'E', 's', 'S', 's', 'S') )
				{
				if (m_r1 <= text.length()-4)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*ful*/'f', 'F', 'u', 'U', 'l', 'L') )
				{
				if (m_r1 <= text.length()-3)
					{
					text.erase(text.end()-3, text.end() );
		...
		void step_4(std::basic_string<Tchar_type, Tchar_traits>& text)
			{	
			if (this->is_suffix(text,/*ement*/'e', 'E', 'm', 'M', 'e', 'E', 'n', 'N', 't', 'T') )
				{
				if (m_r2 <= text.length()-5)
					{
					text.erase(text.end()-5, text.end() );
			...
			else if (this->is_suffix(text,/*ance*/'a', 'A', 'n', 'N', 'c', 'C', 'e', 'E') )
				{
			...
			else if (this->is_suffix(text,/*ence*/'e', 'E', 'n', 'N', 'c', 'C', 'e', 'E') )
				{
				if (m_r2 <= text.length()-4)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*ment*/'m', 'M', 'e', 'E', 'n', 'N', 't', 'T') )
				{
				if (m_r2 <= text.length()-4)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*sion*/'s', 'S', 'i', 'I', 'o', 'O', 'n', 'N') ||
					this->is_suffix(text,/*tion*/'t', 'T', 'i', 'I', 'o', 'O', 'n', 'N') )
				{
			...
			else if (this->is_suffix(text,/*able*/'a', 'A', 'b', 'B', 'l', 'L', 'e', 'E') )
				{
				if (m_r2 <= text.length()-4)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*ible*/'i', 'I', 'b', 'B', 'l', 'L', 'e', 'E') )
				{
				if (m_r2 <= text.length()-4)
					{
					text.erase(text.end()-4, text.end() );
			...
			else if (this->is_suffix(text,/*ant*/'a', 'A', 'n', 'N', 't', 'T') )
				{
				if (m_r2 <= text.length()-3)
					{
					text.erase(text.end()-3, text.end() );
			...
			else if (this->is_suffix(text,/*ent*/'e', 'E', 'n', 'N', 't', 'T') ||
					this->is_suffix(text,/*ism*/'i', 'I', 's', 'S', 'm', 'M') ||
					this->is_suffix(text,/*ate*/'a', 'A', 't', 'T', 'e', 'E') ||
					this->is_suffix(text,/*iti*/'i', 'I', 't', 'T', 'i', 'I') ||
					this->is_suffix(text,/*ous*/'o', 'O', 'u', 'U', 's', 'S') ||
					this->is_suffix(text,/*ive*/'i', 'I', 'v', 'V', 'e', 'E') ||
					this->is_suffix(text,/*ize*/'i', 'I', 'z', 'Z', 'e', 'E') )
				{
				if (m_r2 <= text.length()-3)
					{
					text.erase(text.end()-3, text.end() );
			...
			else if (this->is_suffix(text,/*al*/'a', 'A', 'l', 'L') )
				{
			...
			else if (this->is_suffix(text,/*er*/'e', 'E', 'r', 'R') )
				{
				if (m_r2 <= text.length()-2)
					{
					text.erase(text.end()-2, text.end() );
			...
			else if (this->is_suffix(text,/*ic*/'i', 'I', 'c', 'C') )
				{
				if (m_r2 <= text.length()-2)
					{
					text.erase(text.end()-2, text.end() );
		...
		void step_5(std::basic_string<Tchar_type, Tchar_traits>& text)
			...
			if (is_either(text[text.length()-1], 'e', 'E') )
				...
				this->is_suffix(text,/*ll*/'l', 'L', 'l', 'L') )
				{
				text.erase(text.end()-1, text.end() );
				this->update_r_sections(text);
				}
