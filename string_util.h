...
namespace string_util
	...
	T* stristr(const T* string, const T* strSearch)
		...
		size_t substring_len = std::strlen(strSearch);
	...
	//strchr
	inline char* strchr( char* s, int ch)
		{
		return std::strchr(s, ch);
		}
	inline wchar_t* strchr( wchar_t* s, wchar_t ch)
		{
	...
	inline wchar_t* strstr( wchar_t* s1, const wchar_t* s2)
		{
